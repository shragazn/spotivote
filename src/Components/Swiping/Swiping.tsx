...
export default function Swiping({ token }: Props) {
  ...
  const dequeue = () => {
    setCards(cards.length > 1 ? [...cards.slice(1)] : [...cards]);
  };
    ...
    <>
      <Container className="App">
        {cards.map((card, index) => (
          <Swipable key={card.id} index={index} onTrigger={dequeue}>
            <SongCard currentSong={card} />
          </Swipable>
        ))}
      </Container>
    </>
